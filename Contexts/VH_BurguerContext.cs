...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoriaID).HasName("PK__Categori__F353C1C5A9A9792E");
        ...
        {
            entity.HasKey(e => e.Log_AlteracaoProdutoID).HasName("PK__Log_Alte__D06C51B7713137DF");
        ...
        {
            entity.HasKey(e => e.ProdutoID).HasName("PK__Produto__9C8800C36B1E6360");
            ...
            entity.HasIndex(e => e.Nome, "UQ__Produto__7D8FE3B27CDB1CF0").IsUnique();
        ...
        {
            entity.HasKey(e => e.PromocaoID).HasName("PK__Promocao__254B583DB9177525");
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE798C6C829B8");

            entity.ToTable(tb => tb.HasTrigger("trg_ExclusaoUsuario"));

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534DE7CDC31").IsUnique();
